...
public class Bck_MainActivity extends AppCompatActivity {
    ...
    private void checkStoragePermission() {
        if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(Bck_MainActivity.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_STORAGE);
        }
    }
    ...
    private class LoadGenre extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            adapter = new SongListAdapter(Bck_MainActivity.this,
    ...
    private final MediaBrowserCompat.ConnectionCallback connectionCallbacks =
            new MediaBrowserCompat.ConnectionCallback() {
                ...
                public void onConnected() {
                    ...
                    mediaController = new MediaControllerCompat(Bck_MainActivity.this, // Context
                            token);

                    // Save the controller
                    MediaControllerCompat.setMediaController(Bck_MainActivity.this, mediaController);
